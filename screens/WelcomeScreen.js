  ...
  return (
    <SafeAreaView className="flex-1 bg-white relative">
      ...
      <View className="flex-row justify-between items-center px-6 pt-2">
         <View className="bg-teal-50 p-1.5 rounded-xl">
            <Image 
      ...
      <View className="flex-1 justify-center items-center px-6">
        ...
        <View className="bg-white p-6 rounded-[40px] shadow-sm mb-10 w-64 h-64 justify-center items-center border border-slate-50 shadow-slate-200">
             <Image 
                source={require('../assets/logomeditrack.png')} 
        ...
        <Text className="text-base text-slate-500 text-center font-medium leading-relaxed px-4 mb-4">
          Tu compañero profesional para el control diario de tu medicación y bienestar.
        </Text>
