...
export default function RegisterScreen({ navigation }) {
  ...
  return (
    <SafeAreaView className="flex-1 bg-brand-blue" edges={['top', 'left', 'right']}>
      <StatusBar style="light" />
      
      {/* Background Decor */}
      <View className="absolute top-0 right-0 -mt-10 -mr-10 w-48 h-48 bg-white/10 rounded-full" />

      {/* Header Section MEGA-IMPACT (Vertical with Overlap) */}
      <View className="px-6 pt-2 items-center z-10">
      ...
      {/* Form Card Compact */}
      <View className="flex-1 bg-white rounded-t-[35px] px-8 pt-10 pb-4 shadow-2xl shadow-slate-200 mt-0">
